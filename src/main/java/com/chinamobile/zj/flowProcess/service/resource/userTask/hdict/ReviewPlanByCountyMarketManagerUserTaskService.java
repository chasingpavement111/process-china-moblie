...
public class ReviewPlanByCountyMarketManagerUserTaskService extends BaseUserTaskService implements LimitOperatorRole, ReviewTask {
    ...
    public String getDefinitionKey() {
        return "review_plan_by_county_market_manager";
    }
    ...
    public Map<String, String> supportedOperatorRoleMap() {
        return Collections.singletonMap("hdict010", "市场部经理-县市");
    }
